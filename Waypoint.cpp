...
AWaypoint::AWaypoint()
{
	...
	BoxComponent = CreateDefaultSubobject<UBoxComponent>(TEXT("Trigger_Box"));
...
void AWaypoint::OnPlayerEnter(UPrimitiveComponent* OverlapComponent, AActor* OtherActor, UPrimitiveComponent* 
	                          OtherComponent, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	AAI_Character* Character = nullptr;

	if (OtherActor != nullptr)
	{
		Character = Cast<AAI_Character>(OtherActor);
